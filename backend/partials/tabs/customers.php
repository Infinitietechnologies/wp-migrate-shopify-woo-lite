        ...
        <div class="swi-action-grid">
            ...
            <div class="swi-col-12 swi-form-card">
                ...
                <div class="swi-card-body">
                    <div class="swi-form-field"> <label for="customer-store-id"><?php esc_html_e('Select Store', 'wp-migrate-shopify-woo'); ?></label>
                        ...
                        <p class="description">
                            <?php esc_html_e('Select the Shopify store to import customers from.', 'wp-migrate-shopify-woo'); ?>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swi-form-field swi-action-grid">
                            <div class="swi-checkbox-group swi-col-4 swi-col-sm-12">
                                <label>
                                    ...
                                    <?php esc_html_e('Import Customer Addresses', 'wp-migrate-shopify-woo'); ?>
                                </label>
                                <p class="description">
                                    <?php esc_html_e('Import all customer addresses from Shopify', 'wp-migrate-shopify-woo'); ?>
                                </p>
                            </div>
                            ...
                            <div class="swi-checkbox-group swi-col-4 swi-col-sm-12">
                                <label>
                                    ...
                                    <?php esc_html_e('Send Welcome Email', 'wp-migrate-shopify-woo'); ?>
                                </label>
                                <p class="description">
                                    <?php esc_html_e('Send welcome email to newly imported customers', 'wp-migrate-shopify-woo'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swi-col-12">
                <div class="swi-form-actions">
                    <button type="submit" class="button button-primary" id="start-customers-import">
                        ...
                        <?php esc_html_e('Start Customers Import', 'wp-migrate-shopify-woo'); ?>
                    </button>

                    <button type="button" class="button" id="preview-customers">
                        <span class="dashicons dashicons-visibility"></span>
                        <?php esc_html_e('Preview Customers', 'wp-migrate-shopify-woo'); ?>
                    </button>
                </div>
            </div>
        </div>
