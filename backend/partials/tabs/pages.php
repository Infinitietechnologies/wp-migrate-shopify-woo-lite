...
<div class="wmsw-locked-feature-container">
    <div class="wmsw-locked-feature">
        ...
        <h2 class="wmsw-locked-title"><?php esc_html_e('Pages Import', 'wp-migrate-shopify-woo-lite'); ?></h2>
        
        <p class="wmsw-locked-description">
            <?php esc_html_e('Convert Shopify pages into WordPress pages with professional SEO optimization and content preservation.', 'wp-migrate-shopify-woo-lite'); ?>
        </p>
        ...
        <div class="wmsw-feature-highlights">
            ...
            <div class="wmsw-feature-highlight">
                ...
                <span><?php esc_html_e('Link Fix', 'wp-migrate-shopify-woo-lite'); ?></span>
            </div>
            <div class="wmsw-feature-highlight">
                <div class="wmsw-feature-icon">
        ...
        <div class="wmsw-locked-features">
            <ul>
                <li><?php esc_html_e('✓ Full page content import with HTML preservation', 'wp-migrate-shopify-woo-lite'); ?></li>
                <li><?php esc_html_e('✓ SEO metadata preservation & optimization', 'wp-migrate-shopify-woo-lite'); ?></li>
                <li><?php esc_html_e('✓ Automatic slug conflict resolution', 'wp-migrate-shopify-woo-lite'); ?></li>
                <li><?php esc_html_e('✓ Bulk import with real-time progress tracking', 'wp-migrate-shopify-woo-lite'); ?></li>
                <li><?php esc_html_e('✓ Content quality validation & cleanup', 'wp-migrate-shopify-woo-lite'); ?></li>
                <li><?php esc_html_e('✓ Link validation & automatic fixing', 'wp-migrate-shopify-woo-lite'); ?></li>
            </ul>
        </div>
