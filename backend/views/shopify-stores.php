            ...
            <?php if ((int)$total_stores == 0): ?>
                ...
                <div class="swi-import-section-empty">
                    <div class="swi-empty-state">
                        ...
                        <p class="swi-empty-description"><?php esc_html_e('Connect your first Shopify store to start importing products, customers, and orders.', 'wp-migrate-shopify-woo-lite'); ?></p> <a href="<?php echo esc_url(admin_url('admin.php?page=wp-migrate-shopify-woo-stores&action=add')); ?>" class="swi-btn swi-btn-primary">
                            <span class="dashicons dashicons-plus-alt swi-mr-2"></span>
