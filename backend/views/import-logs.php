...
<div class="wrap swi-admin swi-logs-page">
    <div class="swi-reset">
        ...
        <div class="swi-filters-panel">
            ...
            <div class="swi-filters-body" id="filters-body">
                <form id="swi-logs-filter-form" method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>">
                    ...
                    <input type="hidden" name="page" value="wp-migrate-shopify-woo-lite-logs">
                    <!-- Search Box -->
                    ...
                    <div class="swi-filter-actions">
                        ...
                        <a href="<?php echo esc_url(admin_url('admin.php?page=wp-migrate-shopify-woo-lite-logs')); ?>" class="swi-btn swi-btn-secondary">
        ...
        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($log->task_id && $log->task_type): ?>
                                        <a href="<?php echo esc_url(admin_url('admin.php?page=wp-migrate-shopify-woo-lite-logs&task_id=' . $log->task_id)); ?>">
            ...
            $safe_query_args = [
                'page' => 'wp-migrate-shopify-woo-lite-logs',
