        ...
        <?php if ($total_stores == 0): ?>
            ...
            WMSW_notification(
                sprintf(
                    ...
                    '<a href="' . esc_url(admin_url('admin.php?page=wp-migrate-shopify-woo-stores&action=add')) . '" class="swi-notification-action">' . __('Connect your first store', 'wp-migrate-shopify-woo-lite') . '</a>'
                ),
                'warning',
                [
