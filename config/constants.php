...
define('WMSW_STORE_PAGE', admin_url('admin.php?page=wp-migrate-shopify-woo-lite-stores'));
define('WMSW_SETTINGS_PAGE', admin_url('admin.php?page=wp-migrate-shopify-woo-lite-settings'));
define('WMSW_LOGS_PAGE', admin_url('admin.php?page=wp-migrate-shopify-woo-lite-logs'));
